<?xml version="1.0" encoding="utf-8"?><Profile xmlns="http://soap.sforce.com/2006/04/metadata"><custom>true</custom><profileActionOverrides>
        <actionName>Tab</actionName>
        <content>Sales_Home</content>
        <formFactor>Large</formFactor>
        <pageOrSobjectType>standard-home</pageOrSobjectType>
        <type>Flexipage</type>
    </profileActionOverrides><userLicense>Salesforce</userLicense><classAccesses>
        ...
        <application>Bank_ICICI</application>
        <default>false</default>
        <visible>false</visible>
    </applicationVisibilities><applicationVisibilities>
        <application>Banking_HDFC</application>
        <default>false</default>
        ...
        <editable>true</editable>
        <field>HDFC__c.HDFC_L__c</field>
        <readable>true</readable>
    </fieldPermissions><fieldPermissions>
        <editable>false</editable>
        <field>HDFC__c.HDFC__c</field>
        <readable>true</readable>
    </fieldPermissions><fieldPermissions>
        <editable>false</editable>
        ...
        <layout>HDFC__c-HDFC Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>HDFC__c-HDFC Layout</layout>
        <recordType>HDFC__c.HDFC_RF</recordType>
    </layoutAssignments><layoutAssignments>
        <layout>ICICI__c-ICICI Layout</layout>
    </layoutAssignments><layoutAssignments>
